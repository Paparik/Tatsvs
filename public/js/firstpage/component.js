export const firstpage = {
    ...
    template:`
         <div class="items">
            <default-item-table v-if="role == 'Модератор'" name="Панель администратора">
            ...
            <default-item-table v-if="role == 'Администратор'" name="Панель администратора">

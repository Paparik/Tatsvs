            ...
            <div class="table__item">
                <div class="table__title">
                    ...
                    <div class="constructor__input">
                        <input type="number" 
                        v-model="store.kkForConstructor.length"
                        placeholder="Введите значение">
                    </div>
                </div>
            </div>
            <constructor-input name="Диаметр" v-model:model="store.kkForConstructor.diameter" myplaceholder='Введите значение'></constructor-input>
            <constructor-choice
                name="Материал"
                v-model:model="store.kkForConstructor.material"
                :items="store.promptsOptions.cable_channel_material"
            ></constructor-choice >
            <div class="table__item" v-for="(kabLine, index) in store.kkForConstructor.KabLines">
                <div class="table__title">
                    <p>Кабельная линия</p>
                    <div class="table__title__items">
                        <button @click="store.kkForConstructor.KabLines.splice(index,1)" class="constructor__button" style="margin-right: 0px;">
